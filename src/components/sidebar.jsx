        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Kashish Verma</a></h1>
              <span className="email"><i className="icon-mail"></i> kashishverma245@gmail.com</span>
            </div>
            ...
            <div className="colorlib-footer">
              <p><small>
                  ...
                  Thanks <a href="Google" target="_blank" rel="noopener noreferrer">Google</a> for inspiration 
              </small></p>
              <p><small>
